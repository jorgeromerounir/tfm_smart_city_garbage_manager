...
/**
 * This class is a decorator for the GatewayReqDto object for POST requests.
...
public class PostRequestDecorator extends ServerHttpRequestDecorator {
    ...
    public PostRequestDecorator(GatewayReqDto gatewayReqDto, ObjectMapper objectMapper) {
