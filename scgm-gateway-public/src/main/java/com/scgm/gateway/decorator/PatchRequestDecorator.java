...
/**
 * This class is a decorator for the GatewayReqDto object for PATCH requests.
...
public class PatchRequestDecorator extends ServerHttpRequestDecorator {
    ...
    public PatchRequestDecorator(GatewayReqDto GatewayReqDto, ObjectMapper objectMapper) {
