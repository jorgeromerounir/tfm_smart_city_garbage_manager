  ...
  const features = [
    {
      ...
      description: 'Track waste container levels across the city with live updates',
    },
    {
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" sx={{ mb: 4, fontSize: '1.1rem' }}>
                Monitor waste container levels in real-time, optimize collection routes,
                and manage urban waste efficiently across multiple cities.
              </Typography>
              <Button
                variant="contained"
                size="large"
