...
public class OpeApiConfig {
    ...
    public OpenAPI customOpenAPI(
        ...
        @Value("${swagger.server.url:http://localhost:8180}") String defaultServerUrl,
        @Value("${swagger.server.gateway.url:http://localhost:8762/scgm-routes-api}") String gatewayServerUrl
    ) {
